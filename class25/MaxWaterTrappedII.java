...
import laiofferClass25.PlaceToPutChairI.Pair;
...
public class MaxWaterTrappedII {
	...
	private void processBorder(int[][] matrix, boolean[][] visited, PriorityQueue<Pair>
	 minHeap, int rows, int cols) {
