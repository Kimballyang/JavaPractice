...
public class SortArrayThreeStacks {
	...
	private void sort(LinkedList<Integer> s1, LinkedList<Integer> s2, LinkedList<Integer>
	s3, int length){
		if(length <=1){
			return;
		}
		...
		//after merging, the numbers are in descending order form top to bottom
		// in s3, we need to push them back to s1 to that they are in ascending order
