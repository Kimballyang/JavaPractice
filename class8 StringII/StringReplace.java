...
public class StringReplace {
	...
	public String replaceI(String input, String s, String t){
		// Assumptions: input, s, t are not nulls, s is not empty
	...
	public String replaceLonger(char[] input, String s, String t){
		...
		// char array already, and the original inout string resides
		// on part of the char array starting from index 0.
		// In this solution, we actually allocatem a larger array on demand, and
	...
	// Method2: Using Java's StringBuilder utility and String's indexof()
