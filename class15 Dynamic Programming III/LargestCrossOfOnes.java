...
public class LargestCrossOfOnes {
	public int largest(int[][] matrix){
		//Assumptions: matrixis not null, has size of N *M,
		//where N >= 0 and M >=0.
		int N = matrix.length;
		if(N == 0){
			return 0;
	...
	//in the two matrix, also it returns the max value among all the celss
	...
	//caculate the max possible length of left and up arms
